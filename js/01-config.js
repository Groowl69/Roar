...
const C = {
  ...
  safeR: 400,                 // радиус зоны спавна (увеличено для безопасности)
  ...
  nightOpacity: 0.35,         // затемнение экрана ночью (alpha)
  spawnDelay: 5,              // задержка спавна после входа в ОО
  firstSpawnDelay: 3,         // задержка первого спавна на старте ОО
  respawnT: 7,                // респаун противника
  popMin: 5,                  // мин кол-во активных монстров
  popMax: 7,                  // макс кол-во активных монстров
  trapMin: 3,                 // мин кол-во ловушек
  trapMax: 4,                 // макс кол-во ловушек
  attrMax: 1,                 // макс кол-во артефактов на ОО
